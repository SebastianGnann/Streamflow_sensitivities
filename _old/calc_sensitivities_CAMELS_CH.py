...
from functions import util_TurcPike
...
for id in df_attr["gauge_id"]:
    ...
    # rename variables
    df_tmp = df_tmp.rename(columns={"discharge_spec(mm/d)": "Q",
...
df_attributes_caravan = pd.read_csv(
    ...
    sep=',')
df_attributes_other = pd.read_csv(
    "D:/Data/CAMELS_CH/Caravan_extension_CH/Caravan_extension_CH/attributes/camelsch/attributes_other_camelsch.csv",
    sep=',')
...
# save results
df.to_csv(results_path + 'camels_CH_sensitivities.csv', index=False)
print("Finished saving data.")

df = pd.read_csv(results_path + 'camels_CH_sensitivities.csv')
