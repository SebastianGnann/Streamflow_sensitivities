...
#n=1.86
#df= df[df["country"]==4]
pf.plot_budyko_variable(df, n, "BFI", 0, 1, "magma_r", figures_path)
pf.plot_budyko_variable(df, n, "frac_snow_control", 0, 0.2, "magma_r", figures_path)
pf.plot_budyko_variable(df, n, "P_seasonality_index", -1, 1, "magma_r", figures_path)
pf.plot_budyko_variable(df, n, "cor_PET_P", -0.7, 0.1, "magma_r", figures_path)
